...
{  my ($stem, $suffix, $firstch);
   ...
   # Step 2
   if ($w =~ /(ational|tional|enci|anci|iser|izer|bli|alli|entli|eli|ousli|ization|isation|ation|ator|alism|iveness|fulness|ousness|aliti|iviti|biliti|logi)$/)
   { $stem = $`; $suffix = $1;
   ...
   if ($w =~ /(icate|ative|alize|alise|iciti|ical|ful|ness)$/)
   { $stem = $`; $suffix = $1;
   ...
   if ($w =~ /(al|ance|ence|er|ic|able|ible|ant|ement|ment|ent|ou|ism|ate|iti|ous|ive|ize|ise)$/)
...
sub initialise {
   ...
   %step2list =
   ( 'ational'=>'ate', 'tional'=>'tion', 'enci'=>'ence', 'anci'=>'ance', 'izer'=>'ize', 'iser'=>'ize', 'bli'=>'ble',
     'alli'=>'al', 'entli'=>'ent', 'eli'=>'e', 'ousli'=>'ous', 'ization'=>'ize', 'isation'=>'ize', 'ation'=>'ate',
